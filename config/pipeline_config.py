"""
Centralized configuration for the Insurance Claims Analytics pipeline.
All paths, schemas, partitioning, and merge settings are managed here
for environment portability.

Compatible with:
  - Databricks Community Edition (DBFS paths: /FileStore/)
  - Databricks Workspace with Unity Catalog (Volumes paths: /Volumes/)
  - Local PySpark (local file paths)

Override the base path via environment variable:
  export PIPELINE_BASE_PATH="/Volumes/workspace/default"     # Unity Catalog
  export PIPELINE_BASE_PATH="/FileStore/insurance_claims"     # Community Edition
"""
...
# Expected schemas for validation (column_name: expected_type)
SCHEMAS = {
    "customers": {
        "customer_id": "string",
